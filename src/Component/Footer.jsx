          ...
          <div className="row">
            <div className="col-md-3 col-sm-6 col-12 mb-4">
              <img
                ...
                src="./src/assets/Images/png/fi1.png"
                alt="delivery"
              />
            ...
            <div className="col-md-3 col-sm-6 col-12 mb-4">
              <img
                className="d-flex m-auto mb-3"
                src="./src/assets/Images/png/fi2.png"
                alt="refund"
              />
              <p className="clr_cream fs_sm font_helvetica text-center mb-3">
                SATISFIED OR REFUND
            ...
            <div className="col-md-3 col-sm-6 col-12 mb-4">
              <img
                className="d-flex m-auto mb-3"
                src="./src/assets/Images/png/fi3.png"
                alt="warranty"
              />
              <p className="clr_cream fs_sm font_helvetica text-center mb-3">
                LIFETIME WARRANTY
            ...
            <div className="col-md-3 col-sm-6 col-12 mb-4">
              <img
                className="d-flex m-auto mb-3"
                src="./src/assets/Images/png/fi4.png"
                alt="secure payment"
              />
              <p className="clr_cream fs_sm font_helvetica text-center mb-3">
                SECURE PAYMENTS
      ...
      <div className=" my_container mt-5">
        <div className=" row">
          <div className=" col-lg-3 col-md-6 col-sm-12 mb-4">
            <img
              className=" w-75"
              src="./src/assets/Images/png/logo1.png"
              alt="logo"
            />
            <div className=" d-flex align-items-center justify-content-between mt-4 w-75">
              <img src="./src/assets/Images/png/fcbk.png" alt="facebook" />
              <img src="./src/assets/Images/png/insta.png" alt="instagram" />
              <img src="./src/assets/Images/png/utube.png" alt="youtube" />
              <img src="./src/assets/Images/png/x.png" alt="x" />
            </div>
          ...
          <div className=" row align-items-center justify-content-between mt-3 mb-2 flex-column flex-md-row">
            ...
            <div className=" col-lg-4 col-sm-8">
              <img
                className=" w-100"
                src="./src/assets/Images/png/pay_logo.png"
                alt="payment"
              />
            </div>
          </div>

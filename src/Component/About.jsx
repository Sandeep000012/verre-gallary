            ...
            <div className="col-12 col-md-6 d-flex justify-content-between mb-4 mb-md-0 overflow-hidden">
              <div className=" row align-items-end justify-content-between">
                <div className=" col-md-8 col-8">
                  ...
                  src="./src/assets/Images/png/st1.png"
                  alt="main"
                />
                </div>
                <div className=" col-md-4 col-4">
                  <img
                  className=" stry_img2"
                  src="./src/assets/Images/png/st2.png"
                  alt="overlay"
                />
                </div>
              </div>
          ...
          <div className=" row align-items-center justify-content-between mt-4">
            <div className=" col-sm-6 col-xsm-10 mb-4">
              <div className=" d-flex align-items-center justify-content-between">
                <img
                  ...
                  src="./src/assets/Images/png/p1.png"
                  alt="new product"
                />
                <div>
            ...
            <div className=" col-sm-6 col-xsm-10 mb-4">
              <div className=" d-flex align-items-center justify-content-between">
                <img
                  ...
                  src="./src/assets/Images/png/p2.png"
                  alt="new product"
                />
                <div>
                  <p className=" fs_md clr_grey font_sedan lh-1">
            ...
            <div className=" col-sm-6 col-xsm-10 mb-4">
              <div className=" d-flex align-items-center justify-content-between">
                <img
                  className=" me-4 p_img2"
                  src="./src/assets/Images/png/p3.png"
                  alt="new product"
                />
                <div>
                  <p className=" fs_md clr_grey font_sedan lh-1">
            ...
            <div className=" col-sm-6 col-xsm-10 mb-4">
              <div className=" d-flex align-items-center justify-content-between">
                <img
                  className=" me-3 p_img2"
                  src="./src/assets/Images/png/p4.png"
                  alt="new product"
                />
                <div>
                  <p className=" fs_md clr_grey font_sedan lh-1">
